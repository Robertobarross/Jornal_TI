...
<body>
    ...
    <div id="Postagens" align="center">
        ...
        <textarea name="texto" class="conteudo" placeholder="Digite o conteúdo com no nomáximo 9999 caracteres..." maxlength="900" require></textarea></br>

        <!-- Botões -->
        <p><input type="submit" value="Publicar" class="bt_cad">
        <input type="reset" value="Limpar" class="bt_cad">

        <p><a href="index.php" class="link">Voltar para página inicial</a> | <a href="Menu.php" class="link">Voltar ao Painel</a>
