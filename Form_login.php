...
<div id="Login" align="center">  <!-- Inicio da div Login -->
     ...
     #Login{border: 1px solid gray; margin: 20px 30%; min-height: 370px;}
    .titulo{font-size: 25px; font-family: broadway; padding: 2px;}
    .camp_cad{width: 60%; margin: 2px; height: 15px; padding: 2px;}
    .bt_cad{width:25%; padding: 2px; font-size: 15px; font-family: Arial; color: white; background-color: brown;  border-radius: 10px;}
    .bt_cad:hover{background-color: gray;}
