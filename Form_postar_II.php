...
<div id="Postagens_II" align="center">
        ...
        .bt_cad{width:15%; padding: 2px; font-size: 15px; font-family: Arial; color: white; background-color: gray; border-radius: 10px; }
        .bt_cad:hover{background-color: brown;}
        .Link{width: 40%; font-size: 15px; font-family: Arial; color:blue;}
        </style>

		<p><a href="index.php" class="link">&larr;Voltar para página inicial</a></p>
        <a href="Menu.php" class="link">&larr;Voltar ao Painel</a>
