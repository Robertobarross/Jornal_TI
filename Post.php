...
include 'conect.php';// Arquivo de conexão
...
mysqli_query($link, "INSERT INTO tb_postagens(titulo, imagem, texto, dt, hr, page, id_user)VALUES('$titulo','$imagem','$texto','$dt','$hr','$page','$id_user')");
